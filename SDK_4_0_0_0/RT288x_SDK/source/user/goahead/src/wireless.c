 ...
 *
 *	$Id: wireless.c,v 1.214 2012-02-03 03:37:08 chhung Exp $
 */
...
static int getRax11nDraft3Built(int eid, webs_t wp, int argc, char_t **argv)
{
#if defined (RT2860_11NDRAF3_SUPPORT)
	return websWrite(wp, T("1"));
#else
	return websWrite(wp, T("0"));
#endif
...
static int getRaxHTStream(int eid, webs_t wp, int argc, char_t **argv)
{
#if defined (CONFIG_RALINK_RT3050_1T1R) || defined (CONFIG_RALINK_RT5350)
		websWrite(wp, T("1"));	
#elif defined (CONFIG_RALINK_RT2883) || defined (CONFIG_RALINK_RT3883)
		websWrite(wp, T("3"));
#elif (CONFIG_RT3593_AP_RF_OFFSET == 0x40000)
		websWrite(wp, T("3"));
#else
		websWrite(wp, T("2"));	
#endif
...
static int getRaxABand(int eid, webs_t wp, int argc, char_t **argv)
{
#if defined (RT2860_ABADN_SUPPORT)
	return websWrite(wp, T("1"));
#else
	return websWrite(wp, T("0"));
#endif
