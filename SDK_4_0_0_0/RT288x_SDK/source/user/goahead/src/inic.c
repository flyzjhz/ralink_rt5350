 ...
 *
 *	$Id: inic.c,v 1.51.2.2 2012-02-09 08:00:30 chhung Exp $
 */
...
static int getRaixABand(int eid, webs_t wp, int argc, char_t **argv)
{
#if defined (RTDEV_ABADN_SUPPORT)
	return websWrite(wp, T("1"));
#else
	return websWrite(wp, T("0"));
#endif
...
static int getRaixHTStream(int eid, webs_t wp, int argc, char_t **argv)
{
#if (CONFIG_RT3593_AP_RF_OFFSET == 0x48000 || defined CONFIG_RT3593_AP_MULTIPLE_CARD)
		websWrite(wp, T("3"));
#else
		websWrite(wp, T("2"));	
#endif
...
static int getRaix11nDraft3Built(int eid, webs_t wp, int argc, char_t **argv)
{
#if defined (RTDEV_11NDRAF3_SUPPORT)
	return websWrite(wp, T("1"));
#else
	return websWrite(wp, T("0"));
#endif
