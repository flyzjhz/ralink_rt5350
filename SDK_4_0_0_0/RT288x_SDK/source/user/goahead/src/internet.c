 ...
 *
 *	$Id: internet.c,v 1.203.2.6 2012-02-10 13:26:47 chhung Exp $
 */
...
int initInternet(void)
{
	...
	(CONFIG_RT3090_AP_RF_OFFSET == 0x40000) || (CONFIG_RT3572_AP_RF_OFFSET == 0x40000) || \
	(CONFIG_RT5392_AP_RF_OFFSET == 0x40000) || (CONFIG_RT5572_AP_RF_OFFSET == 0x40000) || \
	(CONFIG_RT5592_AP_RF_OFFSET == 0x40000) || (CONFIG_RT3593_AP_RF_OFFSET == 0x40000) || \
	(CONFIG_RT3680_iNIC_AP_RF_OFFSET == 0x40000)
